package com.baseproject.framework.backup.util;
...
public class MySqlBackupRestoreUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		String database = "baseproject-framework";
		
		System.out.println("开始备份");
		String backupFolderPath = "c:/dev/";
		String fileName = "baseproject-framework.sql";
		backup(host, userName, password, backupFolderPath, fileName, database);
		System.out.println("备份成功");
		
		System.out.println("开始还原");
		String restoreFilePath = "c:/dev/baseproject-framework.sql";
