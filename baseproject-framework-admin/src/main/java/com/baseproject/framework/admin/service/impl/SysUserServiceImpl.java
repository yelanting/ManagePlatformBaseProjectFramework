...
import com.baseproject.framework.admin.dao.SysUserMapper;
import com.baseproject.framework.admin.dao.SysUserRoleMapper;
...
import com.baseproject.framework.admin.service.SysMenuService;
import com.baseproject.framework.admin.service.SysUserService;
import com.baseproject.framework.common.utils.DateTimeUtils;
import com.baseproject.framework.common.utils.PoiUtils;
		...
		if (name != null) {
			if (email != null) {
				pageResult = MybatisPageHelper.findPage(pageRequest,
				        sysUserMapper, "findPageByNameAndEmail", name, email);
			} else {
				pageResult = MybatisPageHelper.findPage(pageRequest,
				        sysUserMapper, "findPageByName", name);
			}
		} else {
